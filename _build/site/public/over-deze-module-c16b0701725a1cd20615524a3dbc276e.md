...
Belangrijke begrippen hierbij zijn: waarden, namen (gekoppeld aan waarden), functie-specificatie (interface): parameters, resultaat; functie-toepassing ("aanroep"), op bepaalde argument-waarden; functie-definitie.

**Hogere-orde functies.**

Belangrijke begrippen: lambda-expressie (anonieme functies)
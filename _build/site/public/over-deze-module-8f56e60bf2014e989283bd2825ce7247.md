...
Een recursieve definitie, van een type of van een functie, heeft naast de recursieve alternatieven tenminste één niet-recursief alternatief, om 

**Lijst als recursief data-type.**

definitie (implementatie) van functies als `map`, `fold` en `filter`.

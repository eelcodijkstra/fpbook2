...
| 8 | grotere voorbeelden | |


## Waarden, expressies en namen

**begrippen**: waarde, expressie, operator, operator-prioriteit (precedentie), naam-definitie, naam-gebruik, rekenen/herschrijven (berekening) 
...
* een expressie bestaat uit waarden (voorlopig alleen gehele getallen), operatoren, en functies (abs, neg; div, mod)

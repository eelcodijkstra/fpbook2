...
**Functies.** Het eerste onderdeel betreft het functiebegrip: een functie als een *uitgestelde berekening*. Er zijn twee redenen om een berekening uit te stellen:

- je kent de invoer (argumenten) van de functie nog niet;
- je hebt het resultaat van de functie nog niet nodig.
